...
此外，通过与CPP算法对比可以发现，算法间的性能差距与量化相移数关系密切。在较高量化精度时，CPP算法的性能与ADSPS算法接近；但当硬件降级至1比特量化或处于非均匀受限状态时，CPP算法的平均SNR比ADSPS算法低约 $0.3 \text{ dB}$。
...
\begin{figure}[!htbp]
	\centering
	%	\includegraphics[width=0.6\linewidth]{ddma/.pdf}
	\caption{xxx}
	\label{fig:}
\end{figure}
